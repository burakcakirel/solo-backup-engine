...
namespace Akeeba\Engine\Restore\Application;

use Akeeba\Engine\Restore\Document\Document;
...
use Akeeba\Engine\Restore\Uri\Uri;
...
abstract class Application
{
	 ...
	 * @throws  ExceptionApp
	 */
	public static function getInstance($name = null, $config = array(), $prefix = 'Angie', Container $container = null)
	{
     ...
     * @throws  ExceptionApp
     */
    public static function getTmpInstance($name, $config = array(), $prefix = 'Angie', Container $container = null)
    {
        ...
        $filePath = module_path('backup-restore', 'Solo') . '/Application.php';
        $result   = include_once($filePath);

        if ($result === false)
        {
            throw new ExceptionApp("The application '$name' was not found on this server");
        }

        $instance = new \Akeeba\Engine\Solo\Application($config, $container);
