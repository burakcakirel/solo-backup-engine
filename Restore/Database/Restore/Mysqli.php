 ...
 */
namespace Akeeba\Engine\Restore\Database\Restore;

use Akeeba\Engine\Restore\Database\Driver;
use Akeeba\Engine\Restore\Database\Restore;
use Exception;

defined('_AKEEBA') or die();

class Mysqli extends Restore
{
	/**
	 * Overloaded constructor, allows us to set up error codes and connect to
	 * the database.
	 *
	 * @param   string $dbkey        @see {Restore}
	 * @param   array  $dbjsonValues @see {Restore}
	 */
