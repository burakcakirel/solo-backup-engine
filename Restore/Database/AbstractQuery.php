...
abstract class AbstractQuery
{
    ...
    /**
     * @var    Query  The query element for a generic query (type = null).
     */
    protected $element = null;

    /**
     * @var    Query  The select element.
     */
    protected $select = null;

    /**
     * @var    Query  The delete element.
     */
    protected $delete = null;

    /**
     * @var    Query  The update element.
     */
    protected $update = null;

    /**
     * @var    Query  The insert element.
     */
    protected $insert = null;

    /**
     * @var    Query  The from element.
     */
    protected $from = null;

    /**
     * @var    Query  The join element.
     */
    protected $join = null;

    /**
     * @var    Query  The set element.
     */
    protected $set = null;

    /**
     * @var    Query  The where element.
     */
    protected $where = null;

    /**
     * @var    Query  The group by element.
     */
    protected $group = null;

    /**
     * @var    Query  The having element.
     */
    protected $having = null;

    /**
     * @var    Query  The column list for an INSERT statement.
     */
    protected $columns = null;

    /**
     * @var    Query  The values list for an INSERT statement.
     */
    protected $values = null;

    /**
     * @var    Query  The order element.
     */
    ...
    /**
     * @var    Query  The call element.
     */
    protected $call = null;

    /**
     * @var    Query  The exec element.
     */
    protected $exec = null;

    /**
     * @var    Query  The union element.
     */
    ...
    public function call($columns)
    {
        ...
        {
            $this->call = new Query('CALL', $columns);
        }
        else
        {
    ...
    public function columns($columns)
    {
        ...
        {
            $this->columns = new Query('()', $columns);
        }
        else
        {
    ...
    {
        $this->type = 'delete';
        $this->delete = new Query('DELETE', null);
     ...
     *
     * Note that 'e' is an alias for this method as it is in Driver.
     *
    ...
    public function exec($columns)
    {
        ...
        {
            $this->exec = new Query('EXEC', $columns);
        }
        else
        {
    ...
    public function from($tables, $subQueryAlias = null)
    {
        if (is_null($this->from))
        {
            ...
            $this->from = new Query('FROM', $tables);
        }
        else
        {
    ...
    public function group($columns)
    {
        ...
        {
            $this->group = new Query('GROUP BY', $columns);
        }
        else
        {
    ...
    public function having($conditions, $glue = 'AND')
    {
        if (is_null($this->having))
        {
            ...
            $this->having = new Query('HAVING', $conditions, " $glue ");
        }
        else
        {
    ...
    {
        $this->type = 'insert';
        $this->insert = new Query('INSERT INTO', $table);
    ...
    {
        $this->type = 'insert';
        $this->insert = new Query('REPLACE INTO', $table);
        $this->autoIncrementField = $incrementField;
    ...
    public function join($type, $conditions)
    {
        ...
        $this->join[] = new Query(strtoupper($type) . ' JOIN', $conditions);
    ...
    public function order($columns)
    {
        ...
        {
            $this->order = new Query('ORDER BY', $columns);
        }
        else
        {
    ...
    public function select($columns)
    {
        ...
        {
            $this->select = new Query('SELECT', $columns);
        }
        else
        {
    ...
    public function set($conditions, $glue = ',')
    {
        ...
        {
            $glue = strtoupper($glue);
            $this->set = new Query('SET', $conditions, "\n\t$glue ");
        }
        else
        {
    ...
    {
        $this->type = 'update';
        $this->update = new Query('UPDATE', $table);
    ...
    public function where($conditions, $glue = 'AND')
    {
        ...
        {
            $glue = strtoupper($glue);
            $this->where = new Query('WHERE', $conditions, " $glue ");
        }
        else
        {
    ...
    public function union($query, $distinct = false, $glue = '')
    {
        ...
        // Get the Query if it does not exist
        if (is_null($this->union))
        {
            $this->union = new Query($name, $query, "$glue");
        }
